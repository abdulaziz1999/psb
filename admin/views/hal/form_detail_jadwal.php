...
<div class="modal-body">
    <form method="POST" action="controllers/jadwalController.php">
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="tgl" value="<?= $detailTa['tgl']?>" id="recipient-name" disabled>
        </div>
        <div class="row">
            <div class="col-md-12">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="form-check mb-1">
                        <input class="form-check-input" type="radio" name="kategori" value="SMP" <?= $detailTa['kategori'] == 'SMP' ? 'checked' : ''?> id="customRadio1" disabled>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="form-check mb-1">
                        <input class="form-check-input" type="radio" name="kategori" value="SMA" id="customRadio2" <?= $detailTa['kategori'] == 'SMA' ? 'checked' : ''?> disabled>
        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="form-check mb-1">
                        <input class="form-check-input" type="radio" name="info" value="true" id="customRadio1" <?= $detailTa['info'] == 'true' ? 'checked' : ''?> disabled>
            ...
            <div class="col-md-6">
                <div class="form-group">
                    <div class="form-check mb-1">
                        <input class="form-check-input" type="radio" name="info" value="false" id="customRadio2" <?= $detailTa['info'] == 'false' ? 'checked' : ''?> disabled>
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" name="kuota" id="recipient-name" value="<?= $detailTa['kuota']?>" disabled>
        </div>
        <div class="form-group">
            <label for="recipient-name" class="col-form-label">Tahunajar :</label>
            <select name="idtahunajar" class="form-control" id="recipient-name" disabled>
                <option disabled selected>Pilih</option>
                <?php foreach($dataTahunajar as $row):?>
                    <?php if($detailTa['id_tahun_ajar'] == $row['id_tahun_ajar']):?>
